...
For the \ce{TRIS}/\ce{HCl} (aq) and \ce{KHP}/\ce{NaOH} (aq) benchmark systems, reagent savings ranged from approximately 10\% (at the strictest 0.010\,mL accuracy threshold) to 30\% (at the 0.050\,mL threshold) relative to a conventional full titration past the equivalence point.
