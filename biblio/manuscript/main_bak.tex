...
Here we introduce a sustainable two-stage analytical strategy based on Gran and Schwartz linearization methods for equivalence point determination with significantly reduced reagent consumption. 
%
...
We have introduced a new, green analytical strategy developed within \textsf{GranTED}, an open-source Python toolkit that implements a two-stage Gran--Schwartz linearization strategy for potentiometric titrations.
